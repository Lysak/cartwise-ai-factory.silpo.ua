ALTER TABLE "OAuthState" ADD COLUMN "purpose" TEXT NOT NULL DEFAULT 'telegram_first';
ALTER TABLE "OAuthState" ADD COLUMN "browserBindingHash" TEXT;
...
ALTER TABLE "McpProbe" RENAME COLUMN "toolNames" TO "toolCatalog";
